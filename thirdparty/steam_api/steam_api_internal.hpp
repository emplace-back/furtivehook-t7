...
extern S_API HSteamPipe S_CALLTYPE SteamAPI_GetHSteamPipe();
extern S_API HSteamUser S_CALLTYPE SteamAPI_GetHSteamUser();
extern S_API HSteamPipe S_CALLTYPE SteamGameServer_GetHSteamPipe();
extern S_API HSteamUser S_CALLTYPE SteamGameServer_GetHSteamUser();
extern S_API void *S_CALLTYPE SteamInternal_ContextInit( void *pContextInitData );
extern S_API void *S_CALLTYPE SteamInternal_CreateInterface( const char *ver );
extern S_API void *S_CALLTYPE SteamInternal_FindOrCreateUserInterface( HSteamUser hSteamUser, const char *pszVersion );
extern S_API void *S_CALLTYPE SteamInternal_FindOrCreateGameServerInterface( HSteamUser hSteamUser, const char *pszVersion );
...
extern S_API void S_CALLTYPE SteamAPI_RegisterCallback( class CCallbackBase *pCallback, int iCallback );
extern S_API void S_CALLTYPE SteamAPI_UnregisterCallback( class CCallbackBase *pCallback );
// Internal functions used by the utility CCallResult objects to receive async call results
extern S_API void S_CALLTYPE SteamAPI_RegisterCallResult( class CCallbackBase *pCallback, SteamAPICall_t hAPICall );
extern S_API void S_CALLTYPE SteamAPI_UnregisterCallResult( class CCallbackBase *pCallback, SteamAPICall_t hAPICall );
