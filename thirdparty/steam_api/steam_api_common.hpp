...
// S_API defines the linkage and calling conventions for steam_api.dll exports
	...
	#define S_API  "C" __declspec( dllexport ) 
	#elif defined( STEAM_API_NODLL )
	#define S_API  "C"
	#else
	#define S_API  "C" __declspec( dllimport ) 
	#endif // STEAM_API_EXPORTS
#elif defined( GNUC )
	#if defined( STEAM_API_EXPORTS )
	#define S_API  "C" __attribute__ ((visibility("default"))) 
	#else
	#define S_API  "C" 
	#endif // STEAM_API_EXPORTS
#else // !WIN32
...
// and call SteamAPI_ReleaseCurrentThreadMemory regularly on other threads.
 extern S_API void S_CALLTYPE SteamAPI_RunCallbacks();
...
// (Or call SetGameserverFlag on your CCallbackBase object.)
 extern S_API void S_CALLTYPE SteamGameServer_RunCallbacks();
