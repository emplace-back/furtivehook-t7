...
namespace game
{
	...
	const static auto LobbyMsgRW_PackageUInt = reinterpret_cast<bool(__fastcall *)(LobbyMsg *, const char *, std::uint32_t*)>(base_address + 0x1EF58F0);
	...
	const static auto LiveSteam_PopOverlayForSteamID = reinterpret_cast<void(__fastcall*)(std::uint64_t)>(base_address + 0x1EB0010);
