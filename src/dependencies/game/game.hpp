...
namespace game
{
	...
	const static auto& s_presenceTable = reinterpret_cast<StructuredTable*>(base_address + 0x1140F060);
	const static auto& cls = reinterpret_cast<clientStatic_t*>(base_address + 0x53DD190);
